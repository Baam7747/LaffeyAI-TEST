            ...
            if (member!.roles.cache.has('857486135717658634') && (interaction.options.getUser('discord_user'))) {
                ...
                userInfo.find({ discordID: discordid }, async (err: Error | null, docs: any[]) => {
                    ...
                    if (docs[0] === undefined) {
                        ...
                        if ((allianceID !== "5476") && (allianceID !== "8594") && (allianceID !== "10382")) {
                            let embed = new x.Embed()
                                .setTitle('Error!')
                            ...
                            const endpoint = `https://api.politicsandwar.com/graphql?api_key=${san}`
                ...
                await interaction.editReply(`Insufficient permissions to see the war chest of others! <:laffno:815323381464432671>\nIf you want to see your own war chest, you can run the command without mentioning anyone.`)
                return
